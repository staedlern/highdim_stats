...
step.model <- caret::train(y ~., data = data,
                           method = "leapForward", 
...
Finally we can retrieve the regression coefficients of the optimal model. Note that the p-values reported in Table \@ref(tab:fwcoef) are invalid.

```{r fwcoef, echo=FALSE}
knitr::kable(broom::tidy(fit.fw),digits=3,booktabs=TRUE,
