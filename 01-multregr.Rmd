# Multiple regression and challenges in high-dimensions
...
In this chapter we will review multiple linear regression and in particular the *Ordinary Least Squares* (OLS) estimator. We will further illustrate challenges in high dimensions.
