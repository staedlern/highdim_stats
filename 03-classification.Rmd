...
\begin{align*}
  \hat{Y}\equiv\hat{G}(X_{\rm new})\equiv\left\{
    \begin{array}{ll}
...
```{r sahd, fig.cap="Pairs plot of variables in the South African Heart Disease Data. Red points indicate cases and blue points indicate controls.",fig.height=10,fig.width=10}
