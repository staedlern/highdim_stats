...
```{r principlecomponent, echo=FALSE, fig.height=10, fig.width=5, fig.cap="Upper plot: 2-dimensional input data. Lower plot: input data rotated using principle component analysis."}
...
dd <- data.frame(beta.ols=beta.ols,beta.ridgecv=beta.ridgecv,
                 beta.ridgebayesian=beta.bayesian)
