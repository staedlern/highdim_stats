...
```{r, echo=FALSE}
# Train the model
step.model <- train(y ~., data = data_train,
                    method = "leapForward", 
...
Before moving the next topic briefly mention two important aspects of Ridge Regression. A disadvantage of Ridge Regression is that it does not perform variable selection. Regression coefficients are only shrunken towards zero. This makes interpration of the optimal learning method more challenging. Another conceptually interesting aspect of Ridge Regression is its relationship to Bayesian statistics...
