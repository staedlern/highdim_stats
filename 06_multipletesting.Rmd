...
This adjustment method is known as the Bonferroni correction. The method has the property that it controls the so-called family-wide-error rate (FWER). Let's assume that $p_0$ is the number of *true* null hypotheses (unknown to the researcher), then we can show 
