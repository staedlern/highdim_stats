...
const <- mean(y)
plot(x, y)
abline(h=const, lty = 1, col = "blue",lwd=3)
lines(x, fx, lwd = 2)
...
plot(x, y)
lines(x, fx, lwd = 2)
lines(x[x<xi[1]], predict(fit.pwc)[x<xi[1]], lty = 1, col = "blue",lwd=3)
lines(x[x>xi[1]&x<xi[2]], predict(fit.pwc)[x>xi[1]&x<xi[2]], lty = 1, col = "blue",lwd=3)
lines(x[x>xi[2]], predict(fit.pwc)[x>xi[2]], lty = 1, col = "blue",lwd=3)
...
plot(x, y)
lines(x, fx, lwd = 2)
lines(x[x<xi[1]], predict(fit.pwl)[x<xi[1]], lty = 1, col = "blue",lwd=3)
lines(x[x>xi[1]&x<xi[2]], predict(fit.pwl)[x>xi[1]&x<xi[2]], lty = 1, col = "blue",lwd=3)
lines(x[x>xi[2]], predict(fit.pwl)[x>xi[2]], lty = 1, col = "blue",lwd=3)
```
