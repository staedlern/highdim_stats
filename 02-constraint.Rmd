# Subset selection, Ridge and Lasso regularization
...
\begin{align*}
\hat{\beta}^{\rm Ridge}_{c}&=\rm{argmin}_{\|\beta\|_2^2\leq c}\rm{RSS}(\beta).
\end{align*}
...
We also try it with a piecewise linear function. 
